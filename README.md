...
- `scripts/`  
  R scripts for data import, quality control and differential expression analysis.  
  Scripts are numbered and should be run in order.

- `results/`  
  Final figures generated by the analysis scripts and included in the lab report.
